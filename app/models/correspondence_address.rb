  ...
  def personal_or_group?
    ...
    not self.online_application.status.nil? and
      (self.online_application.status.include?('personal') or
       self.online_application.status.include?('group')) and
